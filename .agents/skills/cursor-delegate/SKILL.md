...
The workflow requires Node 18+, Git, shell access, and permission to read the
target workspace. Shell examples assume bash/zsh (macOS/Linux, or Git Bash/WSL
on Windows). The optional `--add-dir` flag requires cursor-agent 2026.07.23 or
newer.
