...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-2 font-heading font-medium data-[variant=label]:text-xs data-[variant=legend]:text-sm",
        className
      )}
      {...props}
    />
...
function FieldLabel({ className, ...props }: React.ComponentProps<typeof Label>) {
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label flex w-fit leading-snug group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col has-[>[data-slot=field]]:rounded-none has-[>[data-slot=field]]:border [&>*]:data-[slot=field]:p-2.5",
        className
      )}
      {...props}
    />
