...
| 8 | [phase-8-primitives-and-shell.md](./phase-8-primitives-and-shell.md) | **in progress** | All `components/ui` primitives, shared kit, header/footer/sidenav, account sub-nav, density flip | — |
