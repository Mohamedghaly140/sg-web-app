...
| 11 | [phase-11-contact-and-order-help.md](./phase-11-contact-and-order-help.md) | **in progress** — 11.1 scaffold, 11.2 left column, and 11.3 message form landed (validated mail and WhatsApp handoffs with no false success state); follow-through (11.4) still outstanding | S9 Contact — new route and feature; order-help lookup | 10 (guest lookup) |
