...
| 12 | [phase-12-account-area.md](./phase-12-account-area.md) | **in progress** — 12.1–12.5 done in code, including the S13 order-detail re-skin shared safely with guest tracking; the 12.3–12.5 browser checklists remain pending; 12.3 also extracted `features/shipping/` and moved the addresses panel into URL state; 12.6 (wishlist and Clerk auth screens) remains pre-Classical | S10 Overview (new), S11 Addresses, S12 Orders, S13 Order detail, profile, wishlist | 04, 07, 08, 10, 11 |
