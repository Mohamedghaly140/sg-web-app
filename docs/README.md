...
| 3 | [phase-3-auth-cart-merge.md](./phase-3-auth-cart-merge.md) | **in progress** | Clerk auth, account gate, optional/auth BFF modes, implicit guest-cart merge, profile | 00 (auth), 11 |
