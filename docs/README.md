...
| 10 | [phase-10-bag-and-checkout.md](./phase-10-bag-and-checkout.md) | **in progress** — 10.2–10.3 and 10.5 done; 10.4 in progress; one 10.1 item remains; 10.5 also built the `order-track-lookup` widget and `/orders/track` stub ahead of schedule | S4 Cart, S5 registered, S6 guest, S7 confirmation, shared step rail | 05, 06, 07, 09 |
